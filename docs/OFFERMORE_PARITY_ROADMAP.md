...
- 持续收题：确认当前问题后同时出快答（小模型，2-4 句口语化）和深答（流式，长上下文 / 代码库 Agent），并继续收音等待下一题。
...
| 2 | **自动答题 / 语音触发** | 检测面试官说完（静默）自动触发当前问题回答，减少手动操作 | ✅ 已完成 |
| 3 | **多语言翻译** | 问题/答案双语，外语面试 | ✅ 已完成，见 [multilingual-translation-design.md](./multilingual-translation-design.md) |
| 4 | **深色模式** | 深色 UI 主题切换 | 待做 |
| 5 | **RAG 知识库** | 多文件/向量检索（当前仅单文件），更贴合个人背景 | ✅ 已完成，见 [rag-knowledge-base-design.md](./rag-knowledge-base-design.md) |
